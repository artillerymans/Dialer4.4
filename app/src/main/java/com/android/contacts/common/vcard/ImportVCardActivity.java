...
public class ImportVCardActivity extends Activity {
    ...
    protected Dialog onCreateDialog(int resId, Bundle bundle) {
        if (resId == R.string.import_from_sdcard) {
        ...
        } else if (resId == R.id.dialog_searching_vcard) {
        ...
        } else if (resId == R.id.dialog_sdcard_not_found) {
            ...
            return builder.create();
        } else if (resId == R.id.dialog_vcard_not_found) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(android.R.string.ok, mCancelListener);
            return builder.create();
        } else if (resId == R.id.dialog_select_import_type) {
            return getSelectImportTypeDialog();
        } else if (resId == R.id.dialog_select_multiple_vcard) {
            return getVCardFileSelectDialog(true);
        } else if (resId == R.id.dialog_select_one_vcard) {
            return getVCardFileSelectDialog(false);
        } else if (resId == R.id.dialog_cache_vcard) {
        ...
        } else if (resId == R.id.dialog_io_exception) {
